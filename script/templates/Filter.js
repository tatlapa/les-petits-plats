  ...
  return {
    createFilterElements() {
      const ingredientsFilter = recipe.ingredients.map((ingredient) => {
        ...
        filterIngredient.classList.add("flex", "whitespace-nowrap", "text-ellipsis", "hover:bg-yellow-400", "pl-4", "ingredient", "tag_select");
      ...
      filterAppliance.classList.add("flex", "whitespace-nowrap", "text-ellipsis", "hover:bg-yellow-400", "pl-4", "appliance", "tag_select");
      ...
      const ustensilsFilter = recipe.ustensils.map((ustensil) => {
        ...
        filterUstensil.classList.add("flex", "whitespace-nowrap", "text-ellipsis", "hover:bg-yellow-400", "pl-4", "ustensil", "tag_select");
